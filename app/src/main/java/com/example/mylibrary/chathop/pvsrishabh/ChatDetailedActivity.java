...
import com.example.mylibrary.chathop.pvsrishabh.Adapters.ChatAdapter;
import com.example.mylibrary.chathop.pvsrishabh.Models.MessageModel;
import com.example.mylibrary.chathop.pvsrishabh.databinding.ActivityChatDetailedBinding;
...
public class ChatDetailedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.userToolbarName.setText(userName);
        Picasso.get().load(profilePic).placeholder(R.drawable.avator2).into(binding.profileImage);
